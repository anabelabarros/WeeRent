...
silicone_bib.photo.attach(io: file, filename: "silicone_bib.png", content_type: "image/png")
silicone_bib.save!
...
sippy_cup.photo.attach(io: file, filename: "sippy_cup.png", content_type: "image/png")
sippy_cup.save!
...
silicone_placemat.photo.attach(io: file, filename: "silicone_placemat.png", content_type: "image/png")
...
high_chair_cover.photo.attach(io: file, filename: "high_chair_cover.png", content_type: "image/png")
...
baby_blanket.photo.attach(io: file, filename: "baby_blanket.png", content_type: "image/png")
baby_blanket.save!
...
sleep_sack.photo.attach(io: file, filename: "sleep_sack.png", content_type: "image/png")
sleep_sack.save!
...
night_light.photo.attach(io: file, filename: "night_light.png", content_type: "image/png")
night_light.save!
...
bear_pillow.photo.attach(io: file, filename: "bear_pillow.png", content_type: "image/png")
bear_pillow.save!
...
rattle_ring.photo.attach(io: file, filename: "rattle_ring.png", content_type: "image/png")
rattle_ring.save!
...
activity_gym.photo.attach(io: file, filename: "activity_gym.png", content_type: "image/png")
activity_gym.save!
...
soft_book.photo.attach(io: file, filename: "soft_book.png", content_type: "image/png")
soft_book.save!
...
stacking_cups.photo.attach(io: file, filename: "stacking_cups.png", content_type: "image/png")
stacking_cups.save!
...
baby_carrier.photo.attach(io: file, filename: "baby_carrier.png", content_type: "image/png")
baby_carrier.save!
...
diaper_backpack.photo.attach(io: file, filename: "diaper_backpack.png", content_type: "image/png")
...
stroller_shade.photo.attach(io: file, filename: "stroller_shade.png", content_type: "image/png")
stroller_shade.save!
...
activity_center.photo.attach(io: file, filename: "activity_center.png", content_type: "image/png")
